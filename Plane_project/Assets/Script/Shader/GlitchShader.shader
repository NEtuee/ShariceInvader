...
SubShader {
	Pass {
		...
		half4 frag (v2f i) : SV_Target
		{
			...
			color += fixed4(redcolor.r, redcolor.b, redcolor.g, redcolor.a) *  step(filterRadius, -0.001);
			color *= 1 - 0.5 * step(filterRadius, -0.001);

			color += fixed4(greencolor.g, greencolor.b, greencolor.r, greencolor.a) *  step(0.001, filterRadius);
